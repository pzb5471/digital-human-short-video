...
| Narration duration mismatch | Inspect `revision_required.json`; regenerate only listed segments. Reject final narration above 58 seconds. |
...
| Verification/audit rejects output | Read `verify-report.json`; fix composition or metadata locally. Do not hide provider watermarks or weaken capability checks. |
