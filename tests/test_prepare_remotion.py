...
class PrepareRemotionTests(unittest.TestCase):
    def test_copies_owned_assets_and_uses_public_paths_and_ceil_frames(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            props=prepare_remotion(project_path, root/"public"/"project")
            ...
            self.assertTrue((root/"public"/"project"/"product.png").is_file())
    ...
    def test_rejects_asset_path_escape(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with self.assertRaises(PreparationError): prepare_remotion(project,root/"out")
    ...
    def test_rejects_windows_absolute_symlink_escape_and_name_collision(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with self.assertRaises(PreparationError): prepare_remotion(project,root/"out2")
            ...
            with self.assertRaises(PreparationError): prepare_remotion(project,root/"out3")
